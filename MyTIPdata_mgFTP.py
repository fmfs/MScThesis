...
class ilpTIP(object):
    ...
    def run_big_data(self):
        ...
        for count in range(8000):
            ...
            if os.path.exists("/media/fmfs/Data1"):
                file_path = '/media/fmfs/Data1/Tese/befly/datafiles/mycsv_mgFTP.csv'
            else:
                file_path = '/home/fmfs/befly/datafiles/mycsv_mgFTP.csv'
    ...
    def run_gftp(self):
        ...
        mdl.set_multi_objective(sense = "min", exprs = [obj1, obj2], priorities = [1,1], weights = [1,1], names = ["cost", "time"])
        ...
        if os.path.exists("/media/fmfs/Data1"):
            file_path = '/media/fmfs/Data1/Tese/befly/datafiles/mycsv_mgFTP_solution.csv'
        else:
            file_path = '/home/fmfs/befly/datafiles/mycsv_mgFTP_solution.csv'
        with open(file_path, 'a', newline='') as f:
